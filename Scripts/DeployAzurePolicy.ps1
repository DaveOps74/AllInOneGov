...
$AzureActivityPolicyDefinition = "/providers/Microsoft.Authorization/policyDefinitions/2465583e-4e78-4c15-b6be-a36cbc7c8b0f"
# Deploy - Configure diagnostic settings for Azure Key Vault to Log Analytics workspace #
$AzureKeyVaultPolicyDefinition = "/providers/Microsoft.Authorization/policyDefinitions/951af2fa-529b-416e-ab6e-066fd85ac459"
# Deploy Diagnostic Settings for Logic Apps to Log Analytics workspace #
$AzureLogicAppsPolicyDefinition = "/providers/Microsoft.Authorization/policyDefinitions/b889a06c-ec72-4b03-910a-cb169ee18721"
...
##Start-AzPolicyRemediation -Name "SOC AAL Rem" -PolicyAssignmentId $policyAssignment.PolicyAssignmentId
